...
module.exports = async function sendResetPasswordEmail(
  ...
  const mailOptions = {
    ...
    html: htmlMarkdown(url, username),
  };
...
const htmlMarkdown = (url, username) => `
        ...
        <td align="center">
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        <h1>Hi ${username},</h1>
                        <p>You recently requested to reset your password for your <strong>&lt;Blog /&gt;</strong> account. Use the button below to reset it. <strong>This password reset is only valid for the next 15 minutes.</strong></p>
                        <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                        ...
                        <p>Thanks,
                          <br>The <strong>&lt;Blog /&gt;</strong> team</p>
                        <!-- Sub copy -->
